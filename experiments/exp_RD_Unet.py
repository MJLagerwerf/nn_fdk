...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan  6 16:37:33 2020
...
#%%
@ex.automain
def main(nTD, nVD, train, bpath, stop_crit, specifics, epoch, epochs):
    # Specific phantom
    # %%
    t1 = time.time()
    Q = np.zeros((0, 3))
...
#        print('FDK rec time:', case.FDK.results.rec_time[0])
        ...
        case.table()
        case.show_phantom()
        case.Unet.show(save_name=f'{save_path}Unet_{specifics}_nTD{nTD}_nVD{nVD}')
    return    
